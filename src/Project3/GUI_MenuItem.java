...
public class GUI_MenuItem extends javax.swing.JFrame {
    ...
    private void btnctkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnctkActionPerformed
        ...
        item1.name = txtnama.getText();
        item1.category = txtkategori.getText();
        item1.price = Integer.parseInt(txtharga.getText());
        item1.stock = Integer.parseInt(txtstok.getText());
        item1.description = txtdesk.getText();
        
        //Menampilkan hasil inputan user di memohsl
        memohsl.append("==== Menu Yang Ada di SeaLicious ===\n");
        memohsl.append("--------------------------------------------------------\n");
        memohsl.append("Nama : " + item1.name +"\n");
        memohsl.append("Katagori : " + item1.category + "\n");
        memohsl.append("Harga : " + item1.price + "\n");
        memohsl.append("Stok : " + item1.stock +"\n");
        memohsl.append("Deskripsi : " + item1.description + "\n");
