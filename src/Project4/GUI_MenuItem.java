...
public class GUI_MenuItem extends javax.swing.JFrame {
    ...
    private void btnctkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnctkActionPerformed
        ...
        MenuItem item1 = new MenuItem(); //Membuat Object Dengan Nama item1
        //Mengambil data dari inputan user dan menyimpannya ke masing" atribut melalui setter
        item1.setName(txtnama.getText());
        item1.setCategory(txtkategori.getText());
        item1.setPrice(Integer.parseInt(txtharga.getText()));
        item1.setStock(Integer.parseInt(txtstok.getText()));
        item1.setDescription(txtdesk.getText());
        
        //Menampilkan hasil inputan user di memohsl
        memohsl.append("==== Menu Yang Ada di SeaLicious ===\n");
        memohsl.append("--------------------------------------------------------\n");
        memohsl.append("Nama : " + item1.getName() + "\n");
        memohsl.append("Katagori : " + item1.getCategory() + "\n");
        memohsl.append("Harga : " + item1.getPrice() + "\n");
        memohsl.append("Stok : " + item1.getStock() + "\n");
        memohsl.append("Deskripsi : " + item1.getDescription() + "\n");
